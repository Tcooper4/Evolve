...
class PostUpgradeAuditor:
    ...
    def __init__(self, exclude_dirs: Set[str] = None):
        self.exclude_dirs = exclude_dirs or {'archive', 'legacy', 'test_coverage', '__pycache__', '.git', '.venv', 'venv'}
        self.violations = []
    ...
    def _check_function(self, file_path: str, func_node: ast.FunctionDef, content: str):
        ...
        needs_return = self._function_needs_return(func_node, has_return, has_only_logging, has_side_effects, should_return)
    ...
    def _function_needs_return(self, func_node: ast.FunctionDef, has_return: bool, 
                             has_only_logging: bool, has_side_effects: bool, should_return: bool) -> bool:
    ...
    def _get_violation_reason(self, has_return: bool, has_only_logging: bool, 
                            has_side_effects: bool, should_return: bool) -> str:
