...
class TailRiskEngine:
    ...
    def create_drawdown_heatmap(self, returns: pd.DataFrame, 
                               symbols: List[str]) -> plt.Figure:
    ...
    def _generate_recommendations(self, 
                                ...
                                regime_analysis: List[RegimeAnalysis]) -> List[str]:
...
def calculate_portfolio_risk(returns: pd.Series,
