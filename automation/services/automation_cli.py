...
from typer.colors import RED, GREEN, YELLOW, BLUE
import questionary
...
from .automation_notification import AutomationNotification
...
class AutomationCLI:
    ...
    def _add_commands(self):
        ...
        def tasks(
            ...
            task_type: Optional[TaskType] = Option(
                None,
        ...
        def schedules(
            ...
            limit: int = Option(
                50,
                help="Maximum number of schedules to show"
            )
        ):
            """List schedules."""
            try:
        ...
        def create_schedule(
            ...
            task_type: TaskType = Option(..., help="Task type"),
            cron_expression: Optional[str] = Option(
                None,
                help="Cron expression"
            ),
            interval_seconds: Optional[int] = Option(
                None,
