...
class UIHandler(BaseHandler):
    ...
    def setup_logging(self):
        ...
        log_path = Path("automation/logs/ui")
    ...
    def _load_theme(self) -> Dict:
        ...
        try:
            theme_path = Path("automation/config/theme.yaml")
    ...
    def _load_layouts(self) -> Dict:
        ...
        try:
            layouts_path = Path("automation/config/layouts.yaml")
    ...
    async def update_layout(self, layout_type: str, updates: Dict[str, Any]) -> Dict:
        ...
        try:
            if layout_type not in self.layouts:
                raise ValueError(f"Layout {layout_type} not found")
            ...
            self.logger.info(f"Updated layout: {layout_type}")
    ...
    def get_page_components(self, page_id: str) -> List[UIComponent]:
        ...
        try:
            ...
            self.logger.error(f"Error getting page components: {str(e)}")
            raise
