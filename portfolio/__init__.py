...
def analyze_portfolio(
    assets, strategy="maximum_sharpe", config_path="config/app_config.yaml"
):
    """
    ...
    allocation_result = allocator.allocate_portfolio(
        assets, AllocationStrategy(strategy)
    )
    ...
    if violations:
        ...
        for violation in violations:
            recommendations.append(
                f"- {violation.risk_metric.value}: {violation.action_required}"
            )
    else:
