"""Provider discovery and registry (kept out of trading.data __init__ to slim the barrel)."""
    ...
    def _discover_providers(self):
        ...
        try:
            ...
            try:
                ...
                logger.warning("Alpha Vantage provider not registered: %s", e)
...
def get_data_provider(name: Optional[str] = None) -> Optional[BaseDataProvider]:
    """Universal function to get a data provider (returns BaseDataProvider instance)."""
