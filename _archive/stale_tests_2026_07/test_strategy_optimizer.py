...
class TestStrategyOptimizer:
    ...
    def test_optimizer_initialization(self):
        ...
        config = OptimizerConfig(name="test", optimizer_type="genetic")
    ...
    def test_create_optimizer_pso(self):
        ...
        config = OptimizerConfig(name="test", optimizer_type="pso")
        optimizer = StrategyOptimizer(config)
    ...
    def test_create_optimizer_invalid_type(self):
        ...
        config = OptimizerConfig(name="test", optimizer_type="invalid")
        optimizer = StrategyOptimizer(config)
    ...
    def test_objective_wrapper(self, sample_data, mock_strategy):
        ...
        config = OptimizerConfig(name="test")
        optimizer = StrategyOptimizer(config)
    ...
    def test_optimize_with_genetic(self, sample_data, mock_strategy):
        ...
        config = OptimizerConfig(name="test", optimizer_type="genetic", n_iterations=5)
        optimizer = StrategyOptimizer(config)
    ...
    def test_optimize_with_pso(self, sample_data, mock_strategy):
        ...
        config = OptimizerConfig(name="test", optimizer_type="pso", n_iterations=5)
        optimizer = StrategyOptimizer(config)
    ...
    def test_optimizer_config_validation(self):
        ...
        for opt_type in valid_types:
            config = OptimizerConfig(name="test", optimizer_type=opt_type)
        ...
        with pytest.raises(ValueError, match="optimizer_type must be one of"):
            OptimizerConfig(name="test", optimizer_type="invalid")
    ...
    def test_optimizer_comparison(self, sample_data, mock_strategy):
        ...
        for opt_type in optimizers:
            config = OptimizerConfig(name="test", optimizer_type=opt_type, n_iterations=3)
            optimizer = StrategyOptimizer(config)
    ...
    def test_optimization_metrics_tracking(self, sample_data, mock_strategy):
        ...
        config = OptimizerConfig(name="test", optimizer_type="genetic", n_iterations=3)
        optimizer = StrategyOptimizer(config)
    ...
    def test_optimization_convergence_analysis(self, sample_data, mock_strategy):
        ...
        config = OptimizerConfig(name="test", optimizer_type="genetic", n_iterations=10)
        optimizer = StrategyOptimizer(config)
