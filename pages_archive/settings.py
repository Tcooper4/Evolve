...
def render_settings_page():
    ...
    with col3:
        take_profit = st.number_input(
            "Default Take Profit (%)", 0.1, 20.0, 4.0, step=0.1
        )
    ...
    with col1:
        ...
        enable_caching = st.checkbox(
            "Enable Caching", value=st.session_state.get("enable_caching", True)
        )
    ...
    with col2:
        ...
        enable_debug = st.checkbox(
            "Enable Debug Mode", value=st.session_state.get("enable_debug", False)
        )
            ...
            try:
                ...
                config_data = {
                    "api_config": {
                        ...
                        "alpha_vantage_api_key": st.session_state.get(
                    ...
                    "risk_config": {
                        "max_position_size": st.session_state.get(
                    ...
                    "data_config": {
                        ...
                        "update_frequency": st.session_state.get(
