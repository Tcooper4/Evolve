...
class MonitoringManager:
    ...
    def analyze_metrics(self, days: int = 7):
        ...
        try:
            ...
            print(f"Error Rate: {(stats['application']['errors'] / max(stats['application']['requests'], 1)) * 100:.2f}%")
            print(f"\nLatency:")
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=7,
        help="Number of days for analysis/cleaning"
    )
