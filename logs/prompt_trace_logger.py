...
class PromptTraceLogger:
    ...
    def add_action(
        self, trace_id: str, action_type: str, metadata: Optional[Dict[str, Any]] = None
    ) -> str:
        """
    ...
    def get_traces_by_session(self, session_id: str) -> List[PromptTrace]:
        ...
        """
        return [
            trace for trace in self.traces.values() if trace.session_id == session_id
        ]
    ...
    def get_trace_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_actions_per_trace": (
                total_actions / total_traces if total_traces > 0 else 0
            ),
