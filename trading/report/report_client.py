...
def create_sample_report():
    ...
    trade_data = {
        'trades': [
            {'pnl': 100, 'duration': 3600, 'entry_time': '2024-01-01T10:00:00'},
            {'pnl': -50, 'duration': 1800, 'entry_time': '2024-01-01T12:00:00'},
            {'pnl': 200, 'duration': 7200, 'entry_time': '2024-01-01T15:00:00'},
            {'pnl': 75, 'duration': 5400, 'entry_time': '2024-01-01T18:00:00'},
            {'pnl': -25, 'duration': 2700, 'entry_time': '2024-01-01T21:00:00'}
        ]
    }
    ...
    print(f"Sample report generated: {report_data['report_id']}")
