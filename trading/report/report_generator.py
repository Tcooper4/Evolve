...
class ReportGenerator:
    ...
    def _generate_strategy_reasoning(self, strategy_data: Dict[str, Any]) -> StrategyReasoning:
        ...
        try:
            ...
            try:
                ...
                return {'success': True, 'result': self._generate_fallback_reasoning(strategy_data), 'message': 'Operation completed successfully', 'timestamp': datetime.now().isoformat()}
    ...
    def _generate_fallback_reasoning(self, strategy_data: Dict[str, Any]) -> StrategyReasoning:
        ...
        return {'success': True, 'result': StrategyReasoning(, 'message': 'Operation completed successfully', 'timestamp': datetime.now().isoformat()}
            summary=summary,
    ...
    def _generate_charts(self, trade_data: Dict[str, Any], 
        ...
        return {'success': True, 'result': charts, 'message': 'Operation completed successfully', 'timestamp': datetime.now().isoformat()}
    ...
    def _generate_markdown_report(self, report_data: Dict[str, Any]) -> Path:
        ...
        try:
            ...
            return {'success': True, 'result': filepath, 'message': 'Operation completed successfully', 'timestamp': datetime.now().isoformat()}
...
"""
        return {'success': True, 'result': Template(template_str), 'message': 'Operation completed successfully', 'timestamp': datetime.now().isoformat()}
...
def generate_trade_report(trade_data: Dict[str, Any], 
    ...
    return {'success': True, 'result': generator.generate_comprehensive_report(, 'message': 'Operation completed successfully', 'timestamp': datetime.now().isoformat()}
