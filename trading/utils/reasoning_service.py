    ...
    def _handle_forecast_completed(self, event_data: Dict[str, Any]):
        ...
        try:
            ...
            decision_id = self.reasoning_logger.log_decision(
                ...
                reasoning=reasoning,
                confidence_level=ConfidenceLevel.HIGH if forecast_data.get('confidence', 0) > 0.7 else ConfidenceLevel.MEDIUM,
    ...
    def _handle_strategy_completed(self, event_data: Dict[str, Any]):
        ...
        try:
            ...
            decision_id = self.reasoning_logger.log_decision(
                ...
                reasoning=reasoning,
                confidence_level=ConfidenceLevel.HIGH if strategy_data.get('confidence', 0) > 0.7 else ConfidenceLevel.MEDIUM,
    ...
    def _handle_model_evaluation_completed(self, event_data: Dict[str, Any]):
        ...
        try:
            ...
            decision_id = self.reasoning_logger.log_decision(
                ...
                reasoning=reasoning,
                confidence_level=ConfidenceLevel.HIGH if evaluation_data.get('confidence', 0) > 0.7 else ConfidenceLevel.MEDIUM,
