...
class LoggingManager:
    ...
    def setup_logger(self, name: str, level: str = "INFO", 
                    log_to_file: bool = True, log_to_console: bool = True) -> Dict[str, Any]:
        """
    ...
    def log_event(self, logger_name: str, level: str, message: str, 
...
def log_event(logger_name: str, level: str, message: str, 
              metadata: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
