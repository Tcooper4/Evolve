...
class ConfidenceGenerator:
    ...
    def _ensure_array(self, data: Union[np.ndarray, pd.Series, pd.DataFrame]) -> np.ndarray:
    ...
    def _generate_single_band(
        ...
        **kwargs
        ...
        if method == "bootstrap":
            ...
            return self._volatility_confidence_band(forecast, historical_data, confidence_level, **kwargs)
        elif method == "parametric":
            return self._parametric_confidence_band(forecast, confidence_level, **kwargs)
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_generation": self.generated_bands[-1].generation_timestamp.isoformat()
        }
