...
class ForecastExplainability:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        # SHAP settings
        self.shap_config = self.config.get('shap_config', {
            'max_features': 20,
            'background_samples': 100,
            'explainer_type': 'tree'  # tree, linear, kernel
        })
    ...
    def get_forecast_vs_actual_plot_data(self, symbol: str, days: int = 30) -> Dict[str, Any]:
        ...
        try:
            ...
            recent_accuracy = [a for a in self.accuracy_history 
    ...
    def get_feature_importance_summary(self, symbol: str, days: int = 30) -> Dict[str, Any]:
        ...
        try:
            ...
            cutoff_date = datetime.now() - timedelta(days=days)
            recent_explanations = [e for e in self.explanation_history 
                ...
                'recent_explanations': [
                    {
                        ...
                        'explanation': e.explanation_text[:100] + '...' if len(e.explanation_text) > 100 else e.explanation_text
                    }
