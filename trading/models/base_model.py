...
class BaseModel(ABC):
    ...
    def prepare_data(
        ...
        try:
            ...
            self.logger.info(
                f"Data prepared: {len(train_dataset)} train, {len(val_dataset)} val, {len(test_dataset)} test samples"
            )
    ...
    def _load_model(self, filename: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": True,
                "message": f"Model loaded from {load_path}",
                "timestamp": datetime.now().isoformat(),
            }
    ...
    def _save_training_history(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": True,
                "message": f"Training history saved to {history_file}",
                "timestamp": datetime.now().isoformat(),
            }
    ...
    def plot_training_history(self) -> None:
        ...
        try:
            if not self.train_losses or not self.val_losses:
                ...
                return {
                    "success": False,
                    "error": "No training history to plot",
                    "timestamp": datetime.now().isoformat(),
                }
            ...
            return {
                "success": True,
                "message": f"Training history plot saved to {plot_file}",
                "timestamp": datetime.now().isoformat(),
            }
