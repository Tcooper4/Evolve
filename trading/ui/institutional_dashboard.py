...
class InstitutionalDashboard:
    ...
    def setup_custom_css(self) -> Dict:
        ...
        try:
            ...
            return {
                "success": True,
                "result": {"status": "error", "message": str(e), "css_loaded": False},
    ...
    def render_system_overview(self):
        ...
        if self.system:
            ...
            with col1:
                st.metric("System Status", status["status"].title(), delta=None)
            ...
            with col3:
                ...
                st.metric("Active Modules", modules_count, delta=None)

            with col4:
                health = status.get("system_metrics", {}).get("system_health", 0)
                st.metric("System Health", f"{health:.1%}", delta=None)
    ...
    def render_key_metrics(self):
        ...
        if self.system:
            ...
            if metrics:
                ...
                with col1:
                    st.metric("Total Signals (24h)", metrics.total_signals, delta=None)
    ...
    def render_regime_charts(self):
        ...
        if self.system:
            ...
            if regime_data and "market_regime" in regime_data:
                ...
                fig = go.Figure(data=[go.Pie(labels=regimes, values=counts, hole=0.3)])
