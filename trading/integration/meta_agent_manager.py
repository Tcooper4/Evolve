...
class MetaAgentManager:
    ...
    async def analyze_system_logs(self) -> MetaAgentResult:
        ...
        return await self.execute_agent('log_visualization', analysis_type='comprehensive')
    
    async def generate_system_documentation(self) -> MetaAgentResult:
        """Generate comprehensive system documentation."""
        return await self.execute_agent('documentation_analytics', doc_type='comprehensive')
    
    async def run_security_audit(self) -> MetaAgentResult:
        """Run security audit and checks."""
        return await self.execute_agent('automation_security', audit_type='comprehensive')
    ...
    def get_execution_history(self, agent_name: Optional[str] = None) -> List[MetaAgentResult]:
        """Get execution history."""
        if agent_name:
            return [result for result in self.execution_history if result.agent_name == agent_name]
