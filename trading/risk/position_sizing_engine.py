...
class PositionSizingEngine:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.kelly_config = self.config.get('kelly_config', {
            'fraction': 0.25,  # Use fractional Kelly
            'max_leverage': 2.0,
            'min_size': 0.01
        })
        
        # Volatility parameters
        self.volatility_config = self.config.get('volatility_config', {
            'lookback_period': 252,
        ...
        # Drawdown parameters
        self.drawdown_config = self.config.get('drawdown_config', {
            'max_drawdown': 0.10,
    ...
    def calculate_position_size(self,
                              ...
                              portfolio_context: Optional[Dict[str, Any]] = None) -> PositionSize:
        ...
        try:
            ...
            logger.info(f"Calculated position size for {symbol}: {constrained_size:.2%} "
    ...
    def _hybrid_sizing(self, returns: pd.Series, portfolio_context: Optional[Dict[str, Any]]) -> float:
        ...
        try:
            ...
            hybrid_size = (kelly_size * weights[0] + 
                          vol_size * weights[1] + 
                          dd_size * weights[2])
    ...
    def _apply_constraints(self, 
                          base_size: float,
                          symbol: str,
                          portfolio_context: Optional[Dict[str, Any]]) -> float:
    ...
    def optimize_portfolio_allocation(self,
                                    ...
                                    target_volatility: Optional[float] = None) -> PortfolioAllocation:
