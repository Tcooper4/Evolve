...
class LeaderboardManager:
    ...
    @staticmethod
    def get_top_n_models_by_metric(metric_name: str, top_n: int = 10, 
                                  time_window_days: Optional[int] = None,
                                  min_confidence: float = 0.5,
                                  include_trends: bool = True,
                                  group_by: Optional[str] = None,
                                  sort_ascending: bool = False) -> List[ModelLeaderboardEntry]:
    ...
    def get_leaderboard_summary() -> Dict[str, Any]:
        ...
        try:
            ...
            summary = {
                ...
                'available_metrics': [col for col in df.columns if col not in ['timestamp', 'ticker', 'model', 'strategy', 'notes']],
...
class PerformanceTracker:
    ...
    def get_top_n_models_by_metric(self, metric_name: str, top_n: int = 10, 
                                  time_window_days: Optional[int] = None,
                                  min_confidence: float = 0.5,
                                  include_trends: bool = True,
                                  group_by: Optional[str] = None,
        ...
        return self.leaderboard_manager.get_top_n_models_by_metric(
            metric_name, top_n, time_window_days, min_confidence, 
            include_trends, group_by, sort_ascending
        )
