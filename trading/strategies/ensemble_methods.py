...
def combine_weighted_average(signals: List[StrategySignal], 
                           strategy_weights: Dict[str, float],
                           confidence_threshold: float = 0.6) -> HybridSignal:
...
def combine_voting(signals: List[StrategySignal], 
                  strategy_weights: Dict[str, float],
                  confidence_threshold: float = 0.6) -> HybridSignal:
...
def combine_ensemble_model(signals: List[StrategySignal],
