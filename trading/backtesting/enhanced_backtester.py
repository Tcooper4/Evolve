...
class EnhancedBacktester:
    ...
    def _generate_ensemble_forecasts(
        self, models: List[BaseModel], forecast_period: int, ensemble_method: str
    ) -> Dict[str, Any]:
    ...
    def _default_signal_generation(
        self, signal_data: Dict[str, Any], confidence_threshold: float
    ...
    def _generate_ensemble_backtest_report(
        self,
        results: Dict[str, Any],
        models: List[BaseModel],
        strategy: BaseStrategy,
...
def run_forecast_backtest(
    data: pd.DataFrame, model: BaseModel, strategy: BaseStrategy, symbol: str, **kwargs
) -> Dict[str, Any]:
