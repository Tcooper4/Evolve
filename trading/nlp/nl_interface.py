...
from .prompt_processor import ProcessedPrompt, PromptProcessor
from .response_formatter import ResponseData, ResponseFormatter
...
class NLInterface:
    ...
    def _format_response(
        self, response: Dict[str, Any], session_state: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
    ...
    def _generate_recommendation(self, prompt: ProcessedPrompt) -> ResponseData:
        ...
        try:
            ...
            position_size = self.risk_manager.calculate_position_size(
                market_data, signals, self.portfolio_manager.get_portfolio_value()
            )
