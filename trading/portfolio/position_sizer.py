...
class PositionSizer:
    ...
    def calculate_position_size(
        ...
        try:
            ...
            adjusted_size = self._apply_adjustments(
                base_size, market_context, signal_context, portfolio_context, params
            )
    ...
    def _calculate_base_size(
        ...
        if params.strategy == SizingStrategy.FIXED_PERCENTAGE:
            ...
            return {
                "success": True,
                "result": self._fixed_percentage_size(portfolio_context, params),
                "message": "Operation completed successfully",
                "timestamp": datetime.now().isoformat(),
            }
    ...
    def _volatility_based_size(
        ...
        return {
            "success": True,
            "result": max(0, min(position_size, params.max_position_size)),
            "message": "Operation completed successfully",
            "timestamp": datetime.now().isoformat(),
        }
    ...
    def _martingale_size(
        ...
        return {
            "success": True,
            "result": max(0, min(base_size, params.max_position_size)),
            "message": "Operation completed successfully",
            "timestamp": datetime.now().isoformat(),
        }
