...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("logs/meta_tuner_service.log"), logging.StreamHandler()],
)
...
def main():
    ...
    try:
        ...
        service = MetaTunerService(redis_host="localhost", redis_port=6379, redis_db=0)
