...
from ..agents.performance_critic_agent import PerformanceCriticAgent
...
class PerformanceCriticService(BaseService):
    ...
    def _handle_history_request(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            history = self.agent.get_evaluation_history(
                model_id=model_id,
                limit=limit
            )
    ...
    def get_service_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            recent_evaluations = [
                ...
                if entry.get('agent_name') == 'performance_critic' and 
                   entry.get('decision_type') == 'evaluate_model'
            ]
