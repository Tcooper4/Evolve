...
class ActionPlan:
    ...
    def __post_init__(self):
        ...
        self.export_type = export_mapping.get(
            self.export_type.lower(), self.export_type
        )
    ...
    def __str__(self) -> str:
        ...
        return (
            f"ActionPlan(model='{self.model}', strategy='{self.strategy}', "
...
class PromptParser:
    ...
    def __init__(self, model_name: str = "en_core_web_sm"):
        ...
        try:
            ...
            logger.warning(
                f"spaCy model {model_name} not found, using basic tokenization"
            )
    ...
    def _setup_patterns(self) -> None:
        ...
        model_patterns = [
            ...
            [
                ...
                {
                    "LOWER": {
                        "IN": ["lstm", "transformer", "xgboost", "arima", "prophet"]
                    }
                },
            ],
            [
    ...
    def _classify_model(
        self, doc: Doc, entities: Dict[str, List[str]], patterns: Dict[str, List[str]]
    ) -> str:
        """
    ...
    def get_parsing_statistics(self, action_plans: List[ActionPlan]) -> Dict[str, Any]:
        ...
        stats = {
            ...
            "average_confidence": sum(ap.confidence for ap in action_plans)
            / len(action_plans),
            "model_distribution": {},
        ...
        for plan in action_plans:
            stats["model_distribution"][plan.model] = (
                stats["model_distribution"].get(plan.model, 0) + 1
            )
            stats["strategy_distribution"][plan.strategy] = (
                stats["strategy_distribution"].get(plan.strategy, 0) + 1
            )
            stats["export_distribution"][plan.export_type] = (
                stats["export_distribution"].get(plan.export_type, 0) + 1
            )
