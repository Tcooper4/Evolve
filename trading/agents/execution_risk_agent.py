...
class ExecutionRiskAgent(BaseAgent):
    ...
    def approve_trade(self,
                     ...
                     side: str,
                     price: float,
                     portfolio_context: Optional[Dict[str, Any]] = None) -> TradeApproval:
    ...
    def _check_position_size(self, symbol: str, size: float, portfolio_context: Optional[Dict[str, Any]]) -> Optional[RiskCheck]:
