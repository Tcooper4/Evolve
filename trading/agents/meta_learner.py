...
class MetaLearnerAgent(BaseAgent):
    ...
    async def execute(self, **kwargs) -> AgentResult:
        ...
        try:
            ...
            if action == "store_experience":
                ...
                return AgentResult(success=True, data={"learning_summary": summary})
    ...
    def _update_meta_models(
        ...
        all_actions = set(successful_patterns.get("common_actions", {}).keys()) | set(
            unsuccessful_patterns.get("common_actions", {}).keys()
        )
