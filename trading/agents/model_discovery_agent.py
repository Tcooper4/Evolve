...
class ModelBenchmarker:
    ...
    def benchmark_model(self, model_discovery: ModelDiscovery) -> BenchmarkResult:
        ...
        try:
            ...
            logger.info(f"Benchmark completed for {model_discovery.model_id}: Score={overall_score:.3f}, Approved={is_approved}")
...
class ModelDiscoveryAgent:
    ...
    def benchmark_discoveries(self, discoveries: List[ModelDiscovery]) -> List[BenchmarkResult]:
        ...
        try:
            ...
            logger.info(f"Benchmark completed. Approved: {self.discovery_stats['total_approved']}, Rejected: {self.discovery_stats['total_rejected']}")
