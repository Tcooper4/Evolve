...
class MetaTunerAgent:
    ...
    def _bayesian_optimization(self, tuning_id: str, model_type: str, 
                             ...
                             n_trials: Optional[int]) -> TuningResult:
    ...
    def _grid_search(self, tuning_id: str, model_type: str, 
                    objective_function: Callable, param_space: Dict[str, Any], 
                    n_trials: Optional[int]) -> TuningResult:
    ...
    def _random_search(self, tuning_id: str, model_type: str, 
                      objective_function: Callable, param_space: Dict[str, Any], 
                      n_trials: Optional[int]) -> TuningResult:
    ...
    def _create_result_from_historical(self, tuning_id: str, model_type: str, 
                                     historical_result: TuningResult) -> TuningResult:
