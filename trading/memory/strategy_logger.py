...
class StrategyLogger:
    ...
    def save_strategy_regime_mapping(self, strategy_name: str, regime: str, 
    ...
    def get_best_strategy_for_regime(self, regime: str, 
    ...
    def get_strategy_regime_performance(self, strategy_name: str, 
        ...
        try:
            ...
            if regime:
                ...
                if regime_count > 0:
                    for key in ['avg_confidence', 'avg_win_rate', 'avg_sharpe_ratio', 'avg_total_return', 'avg_max_drawdown']:
    ...
    def _analyze_regime_performance(self, strategy_name: str, regime: str, 
                                  regime_data: List[Dict[str, Any]]) -> Dict[str, Any]:
