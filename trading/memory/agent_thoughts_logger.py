...
class AgentThoughtsLogger:
    ...
    def create_task(self, task_type: str, agent_name: str, 
                   priority: int = 1, parent_task_id: Optional[str] = None,
    ...
    def log_thought_with_timing(self,
                              agent_name: str,
                              task_id: str,
                              context: str,
                              decision: str,
    ...
    def search_thoughts_by_tags(self, 
                               tags: List[str], 
    ...
    def get_thoughts_by_confidence_range(self,
    ...
    def get_thoughts_by_context_keywords(self,
                                        keywords: List[str],
                                        agent_name: Optional[str] = None,
                                        task_id: Optional[str] = None,
                                        limit: int = 50) -> List[Dict[str, Any]]:
    ...
    def get_agent_performance_summary(self, agent_name: str, task_id: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            successful_thoughts = len([t for t in thoughts if t.get("outcome") and "success" in t.get("outcome", "").lower()])
