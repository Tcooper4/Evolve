...
class AgentLogger:
    ...
    def register_agent_context(self, agent_name: str, agent_type: AgentType, 
                             context: Optional[Dict[str, Any]] = None) -> AgentContext:
    ...
    def log_action(self, agent_name: str, action: AgentAction, message: str,
                  ...
                  error_details: Optional[str] = None, task_id: Optional[str] = None,
                  correlation_id: Optional[str] = None) -> Optional[AgentLogEntry]:
        ...
        try:
            ...
            if agent_context is None:
                ...
                agent_context = self.register_agent_context(
                    agent_name, 
                    AgentType.MODEL_SELECTOR,  # Default type
                    context
                )
    ...
    def get_performance_summary(self, hours: int = 24) -> Dict[str, Any]:
        ...
        try:
            ...
            for log in logs:
                ...
                if (summary['agent_activity'][agent_name]['last_action'] is None or 
                    log.timestamp > summary['agent_activity'][agent_name]['last_action']):
