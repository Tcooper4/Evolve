...
class PerformanceWeightsManager:
    ...
    def update_weights_with_sharpe(self, ticker: str, model_performance: Dict[str, float], 
        ...
        try:
            ...
            for model, performance in model_performance.items():
                ...
                if len(self.performance_history[ticker][model]) >= window_size:
                    recent_performance = [record['performance'] for record in self.performance_history[ticker][model][-window_size:]]
