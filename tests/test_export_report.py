...
class TestExportReport(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_data = {
            ...
            "trades": [
                {"timestamp": "2023-01-01", "symbol": "AAPL", "side": "buy", "quantity": 100, "price": 150.0, "pnl": 500.0},
                {"timestamp": "2023-01-02", "symbol": "GOOGL", "side": "sell", "quantity": 50, "price": 2800.0, "pnl": -200.0},
                {"timestamp": "2023-01-03", "symbol": "MSFT", "side": "buy", "quantity": 75, "price": 300.0, "pnl": 750.0}
            ],
            "charts": {
    ...
    def test_html_export_without_charts(self):
        ...
        result = self.exporter.export_to_html(self.sample_data, "test_no_charts.html", include_charts=False)
    ...
    def test_zipped_export_missing_files(self):
        ...
        result = self.exporter.create_zipped_export(["nonexistent_file.csv"], "missing_bundle.zip")
