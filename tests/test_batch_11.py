...
class TestStrategyComposer(unittest.TestCase):
    ...
    def test_toggle_sub_strategy(self):
        ...
        result = self.composer.toggle_sub_strategy(
            "test_strategy", False, "test reason"
        )
    ...
    def test_conditional_toggle(self):
        ...
        conditions = {"volatility_threshold": 0.2, "market_regime": ["bull", "neutral"]}

        result = self.composer.set_conditional_toggle(
            "test_strategy", conditions, "conditional test"
        )
        ...
        self.assertEqual(
            self.composer.sub_strategies["test_strategy"].conditions, conditions
        )
    ...
    def test_evaluate_conditions(self):
        ...
        self.composer.add_sub_strategy(
            "test_strategy", conditions={"volatility_threshold": 0.2}
        )
        self.composer.set_conditional_toggle(
            "test_strategy", {"volatility_threshold": 0.2}
        )
...
class TestEnhancedLogging(unittest.TestCase):
    ...
    def test_enhanced_logger_creation(self):
        ...
        logger = self.log_manager.get_enhanced_logger(
            "test_logger", log_file="test.log", enable_console=True, enable_file=True
        )
    ...
    def test_timed_rotating_handler(self):
        ...
        logger = self.log_manager.setup_timed_rotating_handler(
            "timed_logger", "timed.log", when="midnight", interval=1, backup_count=5
        )
    ...
    def test_memory_handler(self):
        ...
        logger = self.log_manager.setup_memory_handler(
            "memory_logger", capacity=100, flushLevel=logging.ERROR
        )
    ...
    def test_queue_handler(self):
        """Test queue handler."""
        logger = self.log_manager.setup_queue_handler("queue_logger", queue_size=100)
...
class TestRiskManager(unittest.TestCase):
    ...
    def test_dynamic_volatility_model_initialization(self):
        ...
        self.assertIsInstance(
            self.risk_manager.volatility_model, DynamicVolatilityModel
        )
    ...
    def test_dynamic_position_sizing(self):
        ...
        recommendation = self.risk_manager.calculate_dynamic_position_size(
            symbol="AAPL", base_position_size=0.05, confidence_score=0.8
        )
        ...
        self.assertLessEqual(
            recommendation.final_recommendation, 0.1
        )  # max position size
    ...
    def test_volatility_model_update(self):
        ...
        result = self.risk_manager.update_volatility_model(
            VolatilityModel.EWMA, window=100, alpha=0.95
        )

        self.assertTrue(result)
        self.assertEqual(
            self.risk_manager.volatility_model.model_type, VolatilityModel.EWMA
        )
...
class TestVisualizer(unittest.TestCase):
    ...
    def test_dataframe_validation_failure(self):
        ...
        with self.assertRaises(DataValidationError):
            self.visualizer.validate_dataframe(
                self.sample_data, required_columns=["timestamp", "missing_column"]
            )
    ...
    def test_candlestick_chart_creation(self):
        ...
        fig = self.visualizer.plot_candlestick_chart(
            self.price_data, title="Test Candlestick"
        )
    ...
    def test_line_chart_creation(self):
        ...
        fig = self.visualizer.plot_line_chart(
            self.sample_data, y_column="close", title="Test Line Chart"
        )
    ...
    def test_histogram_creation(self):
        ...
        fig = self.visualizer.plot_histogram(
            self.sample_data, column="close", title="Test Histogram"
        )
    ...
    def test_scatter_plot_creation(self):
        ...
        fig = self.visualizer.plot_scatter(
            self.sample_data, x_column="volume", y_column="close", title="Test Scatter"
        )
    ...
    def test_heatmap_creation(self):
        ...
        fig = self.visualizer.plot_heatmap(correlation_matrix, title="Test Heatmap")

        self.assertIsInstance(fig, go.Figure)

    def test_chart_export(self):
        """Test chart export."""
        fig = self.visualizer.plot_line_chart(self.sample_data, y_column="close")
...
class TestMathHelpers(unittest.TestCase):
    ...
    def test_rolling_statistics(self):
        ...
        stats = calculate_rolling_statistics(
            self.returns, window=20, statistics=["mean", "std", "min", "max", "median"]
        )
    ...
    def test_momentum_score(self):
        ...
        momentum = calculate_momentum_score(
            self.prices, short_window=10, long_window=50
        )
    ...
    def test_regime_probability(self):
        ...
        probabilities = calculate_regime_probability(
            self.returns, regimes=["bull", "bear", "sideways"], window=60
        )
    ...
    def test_correlation_regime(self):
        ...
        regimes = calculate_correlation_regime(
            self.returns, self.market_returns, window=60
        )
    ...
    def test_information_ratio(self):
        ...
        ir = calculate_information_ratio(self.returns, self.market_returns, window=60)
    ...
    def test_treynor_ratio(self):
        ...
        tr = calculate_treynor_ratio(
            self.returns, self.market_returns, risk_free_rate=0.02, window=60
        )
    ...
    def test_sortino_ratio(self):
        ...
        sr = calculate_sortino_ratio(self.returns, risk_free_rate=0.02, window=60)
    ...
    def test_calmar_ratio(self):
        ...
        cr = calculate_calmar_ratio(self.prices, window=60)
