...
class TestRiskMetrics(unittest.TestCase):
    ...
    def test_advanced_metrics(self):
        ...
        # Check keys
        expected_keys = ["var_95", "cvar_95", "tail_risk", "skewness", "kurtosis"]
    ...
    def test_regime_metrics(self):
        ...
        # Check keys
        expected_keys = ["regime", "sharpe_ratio", "volatility", "max_drawdown"]
        self.assertTrue(all(key in metrics for key in expected_keys))
    ...
    def test_max_drawdown_period_and_sharpe_sign_flip(self):
        ...
        for scenario in scenarios:
            ...
            self.assertTrue(
                start_period <= min_dd_period <= end_period,
        ...
        self.assertTrue(
            np.isnan(zero_vol_sharpe) or np.isinf(zero_vol_sharpe),
