    ...
    def test_oversold_overbought_threshold_variation_intraday(self):
        ...
        for timeframe in timeframes:
            ...
            for i, thresholds in enumerate(threshold_combinations):
                ...
                if 'strategy_returns' in result.columns:
                    ...
                    if len(strategy_returns) > 0:
                        ...
                        periods_per_year = 24 * 365 if timeframe['freq'] == 'H' else 48 * 365 if timeframe['freq'] == '30T' else 96 * 365
            ...
            if len(timeframe_results) > 1:
                ...
                self.assertGreater(max(sharpe_ratios) - min(sharpe_ratios), 0.1, 
        ...
        if sensitivity_results:
            ...
            print(f"    Best threshold combination: {best_combination['buy_threshold']}/{best_combination['sell_threshold']}")
            ...
            for result in sensitivity_results:
                if result != best_combination:
                    ...
                    if sharpe_diff > sensitivity_threshold:
                        print(f"    High sensitivity: {result['buy_threshold']}/{result['sell_threshold']} -> {sharpe_diff:.1%} change")
        ...
        for timing_thresh in timing_thresholds:
            ...
            for i, signal in enumerate(timing_result['signal']):
                ...
                elif cycle_position > 0.5 and cycle_position < 0.75 and signal == -1:  # Sell signal in overbought period
