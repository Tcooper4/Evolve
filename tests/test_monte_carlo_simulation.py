...
class TestMonteCarloSimulation(unittest.TestCase):
    ...
    def test_block_bootstrap(self):
        ...
        config = MonteCarloConfig(n_simulations=100, bootstrap_method="block", block_size=10)
        simulator = MonteCarloSimulator(config)
    ...
    def test_portfolio_value_calculation(self):
        ...
        portfolio_paths = simulator._calculate_portfolio_values(return_paths, initial_capital)
    ...
    def test_get_summary_statistics(self):
        ...
        expected_keys = [
            'mean_final_value', 'std_final_value', 'mean_total_return',
            'std_total_return', 'min_final_value', 'max_final_value',
            'var_95', 'var_99', 'probability_of_loss'
        ]
