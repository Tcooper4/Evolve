...
from trading.ui.cost_config import CostConfigUI, _get_preset_params, _show_cost_breakdown_preview
...
class TestPerformanceAnalyzer:
    ...
    def test_cost_adjusted_metrics(self):
        ...
        gross_return = self.analyzer._calculate_basic_returns(self.equity_curve)['total_return']
    ...
    def test_compute_metrics_integration(self):
        ...
        basic_metrics = ['total_return', 'annualized_return', 'sharpe_ratio', 'max_drawdown']
...
class TestCostModel:
    ...
    def test_calculate_total_cost(self):
        ...
        expected_total = cost_breakdown['fees'] + cost_breakdown['spread'] + cost_breakdown['slippage']
...
class TestCostConfigUI:
    ...
    def test_cost_breakdown_preview(self):
        ...
        commission = max(min_commission, min(trade_value * commission_rate, max_commission))
...
class TestCostModelingIntegration:
    ...
    def test_cost_impact_scenarios(self):
        ...
        # Higher costs should result in lower cost-adjusted returns
        assert results['low_cost']['cost_adjusted_return'] > results['medium_cost']['cost_adjusted_return']
        assert results['medium_cost']['cost_adjusted_return'] > results['high_cost']['cost_adjusted_return']
        
        # Higher costs should result in higher total trading costs
        assert results['low_cost']['total_trading_costs'] < results['medium_cost']['total_trading_costs']
        assert results['medium_cost']['total_trading_costs'] < results['high_cost']['total_trading_costs']
