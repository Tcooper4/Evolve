...
class TestForecastRouter(unittest.TestCase):
    ...
    def test_get_forecast_with_empty_data(self):
        ...
        result = self.router.get_forecast(data=empty_data, horizon=30)
    ...
    def test_get_forecast_with_none_data(self):
        ...
        result = self.router.get_forecast(data=None, horizon=30)
    ...
    def test_get_forecast_with_invalid_horizon(self):
        ...
        result = self.router.get_forecast(data=self.sample_data, horizon=-5)
    ...
    def test_error_handling(self):
        ...
        result = self.router.get_forecast(data=corrupted_data, horizon=30)
    ...
    def test_invalid_input_prompts(self):
        ...
        result = self.router.get_forecast(data=None, horizon=30, prompt=None)
        self.assertIsInstance(result, dict)
        self.assertIn("forecast", result)
        self.assertIn("error", result.get("metadata", {}))

        # Test with empty string prompt
        result = self.router.get_forecast(data=self.sample_data, horizon=30, prompt="")
        self.assertIsInstance(result, dict)
        self.assertIn("forecast", result)

        # Test with malformed prompt (non-string)
        result = self.router.get_forecast(data=self.sample_data, horizon=30, prompt=123)
        self.assertIsInstance(result, dict)
        self.assertIn("forecast", result)
    ...
    def test_default_fallback_behavior(self):
        ...
        result = self.router.get_forecast(data=self.sample_data, horizon=30)
