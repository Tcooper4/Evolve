...
from trading.agents.optimization.parameter_validator import (
    OptimizationParameter,
    ParameterValidator,
)
from trading.agents.optimization.performance_analyzer import (
    OptimizationResult,
    PerformanceAnalyzer,
)
...
class TestParameterValidator:
    ...
    def test_parameter_range_generation(self):
        ...
        param = OptimizationParameter(
            name="rsi_period", min_value=10, max_value=20, step=2, parameter_type="int"
        )
    ...
    def test_categorical_parameter(self):
        ...
        validated_params = validator.validate_optimization_parameters(
            [categorical_param]
        )
        assert len(validated_params) == 1
...
class TestPerformanceAnalyzer:
    ...
    def test_find_optimal_parameters(self):
        ...
        assert (
            optimal_params[0]["performance_metrics"]["sharpe_ratio"]
            > optimal_params[1]["performance_metrics"]["sharpe_ratio"]
        )
