...
from trading.agents.prompt_response_validator import (
    PromptResponseValidator,
    ValidationLevel,
)
from trading.ensemble.diagnostic_tools import EnsembleDiagnosticTools
from trading.strategies.strategy_fallback import StrategyFallback
...
class TestStrategyFallback(unittest.TestCase):
    ...
    def test_fallback_execution_order(self):
        ...
        with patch.object(self.fallback, "_execute_strategy") as mock_execute:
            ...
            self.fallback.execute_fallback(market_data, context)
    ...
    def test_performance_update(self):
        ...
        trade_result = {"pnl": 0.02, "win": True, "strategy_used": "RSI"}
...
class TestPromptResponseValidator(unittest.TestCase):
    ...
    def test_missing_required_fields(self):
        ...
        self.assertTrue(
            any("Missing required field" in error for error in result.errors)
        )
