...
class SystemUpgradeTester:
    ...
    def test_core_modules(self):
        ...
        try:
            ...
            self.assert_test("CapabilityRouter Status", 
                           isinstance(capabilities, dict))
            
            # Test system health
            health = get_system_health()
            self.assert_test("CapabilityRouter Health", 
                           isinstance(health, dict) and 'overall_status' in health)
    ...
    def test_rl_trader(self):
        ...
        try:
            ...
            self.assert_test("RL Trader Model Status", 
                           isinstance(status, dict))
            
            # Test system health
            health = rl_trader.get_system_health()
            self.assert_test("RL Trader Health", 
                           isinstance(health, dict) and 'overall_status' in health)
            ...
            self.assert_test("RL Trader Training Result", 
            ...
            try:
                ...
                if hasattr(module, component):
                    ...
                    if hasattr(instance, 'get_system_health'):
                        ...
                        self.assert_test(f"{name} Health Method", 
                                       isinstance(health, dict) and 'overall_status' in health)
                    else:
