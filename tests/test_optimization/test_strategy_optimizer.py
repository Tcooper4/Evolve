...
from trading.optimization.strategy_optimizer import (
    StrategyOptimizer, StrategyOptimizerConfig, 
...
class TestGeneticAlgorithm:
    ...
    def test_genetic_algorithm_optimization(self, sample_data, param_space):
        ...
        result = ga.optimize(objective, param_space, sample_data, 
    ...
    def test_genetic_algorithm_early_stopping(self, sample_data, param_space):
        ...
        result = ga.optimize(objective, param_space, sample_data,
                           population_size=5, n_generations=20)
...
class TestParticleSwarmOptimization:
    ...
    def test_pso_optimization(self, sample_data, param_space):
        ...
        result = pso.optimize(objective, param_space, sample_data,
    ...
    def test_pso_parameter_sensitivity(self, sample_data, param_space):
        ...
        result1 = pso.optimize(objective, param_space, sample_data,
                              n_particles=5, n_iterations=5,
                              inertia_weight=0.5, cognitive_weight=1.0, social_weight=1.0)
        
        result2 = pso.optimize(objective, param_space, sample_data,
                              n_particles=5, n_iterations=5,
                              inertia_weight=0.9, cognitive_weight=2.0, social_weight=2.0)
...
class TestStrategyOptimizer:
    ...
    def test_optimization_convergence_analysis(self, sample_data, mock_strategy):
        ...
        with patch.object(optimizer.optimizer, 'optimize') as mock_optimize:
            ...
            assert mock_optimize.return_value.convergence_history[0] > mock_optimize.return_value.convergence_history[-1] 