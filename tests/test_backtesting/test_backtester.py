...
class TestBacktester:
    ...
    def test_commission_calculation(self, backtester, sample_data, sample_signals):
        ...
        assert (trades['commission'] == trades['position'].abs() * 
                sample_data['close'] * backtester.commission).all()
    ...
    def test_slippage_application(self, backtester, sample_data, sample_signals):
        ...
        assert (trades['slippage'] == trades['position'].abs() * 
                sample_data['close'] * backtester.slippage).all()
    ...
    def test_position_limits(self, backtester, sample_data):
        ...
        assert (trades['position'] * sample_data['close'] <= 
                backtester.initial_balance).all()
