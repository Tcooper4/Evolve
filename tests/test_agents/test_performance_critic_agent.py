...
from trading.agents.performance_critic_agent import (
    PerformanceCriticAgent, ModelEvaluationRequest, ModelEvaluationResult
)
...
class TestModelEvaluationResult:
    ...
    def test_model_evaluation_result_creation(self):
        ...
        assert result.benchmark_comparison == {"excess_return": 0.05, "information_ratio": 0.8}
...
class TestPerformanceCriticAgent:
    ...
    def mock_model(self, temp_data_dir):
        ...
        model = Mock()
        model.predict.return_value = np.random.randn(252) * 0.01 + 0.001  # Small returns
    ...
    def test_performance_critic_agent_validate_input_valid(self, performance_critic_agent, mock_model):
    ...
    def test_performance_critic_agent_validate_input_invalid_model_path(self, performance_critic_agent):
    ...
    def test_performance_critic_agent_validate_input_invalid_test_data_path(self, performance_critic_agent, mock_model):
    ...
    def test_performance_critic_agent_validate_input_invalid_evaluation_period(self, performance_critic_agent, mock_model):
    ...
    def test_performance_critic_agent_validate_input_missing_request(self, performance_critic_agent):
        """Test input validation with missing request."""
        assert performance_critic_agent.validate_input() is False
    
    def test_performance_critic_agent_validate_input_wrong_type(self, performance_critic_agent):
    ...
    @pytest.mark.asyncio
    async def test_performance_critic_agent_execute_success(self, performance_critic_agent, mock_model, sample_test_data):
    ...
    @pytest.mark.asyncio
    async def test_performance_critic_agent_execute_invalid_request(self, performance_critic_agent):
    ...
    @pytest.mark.asyncio
    async def test_performance_critic_agent_execute_wrong_request_type(self, performance_critic_agent):
    ...
    @pytest.mark.asyncio
    async def test_performance_critic_agent_evaluate_lstm_model(self, performance_critic_agent, mock_model, sample_test_data):
    ...
    @pytest.mark.asyncio
    async def test_performance_critic_agent_evaluate_xgboost_model(self, performance_critic_agent, mock_model, sample_test_data):
    ...
    @pytest.mark.asyncio
    async def test_performance_critic_agent_evaluate_with_benchmark(self, performance_critic_agent, mock_model, sample_test_data):
    ...
    @pytest.mark.asyncio
    async def test_performance_critic_agent_evaluate_with_custom_period(self, performance_critic_agent, mock_model, sample_test_data):
    ...
    def test_performance_critic_agent_get_evaluation_history(self, performance_critic_agent, mock_model, sample_test_data):
        ...
        assert all(isinstance(eval_result, ModelEvaluationResult) for eval_result in history)
    
    def test_performance_critic_agent_get_evaluation_history_nonexistent(self, performance_critic_agent):
    ...
    def test_performance_critic_agent_get_model_performance_summary(self, performance_critic_agent, mock_model, sample_test_data):
...
class TestPerformanceCriticAgentErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_performance_critic_agent_evaluate_with_missing_model(self, performance_critic_agent, sample_test_data):
    ...
    @pytest.mark.asyncio
    async def test_performance_critic_agent_evaluate_with_missing_test_data(self, performance_critic_agent, mock_model):
    ...
    @pytest.mark.asyncio
    async def test_performance_critic_agent_evaluate_with_invalid_model_type(self, performance_critic_agent, mock_model, sample_test_data):
...
class TestPerformanceCriticAgentMetrics:
    ...
    def test_performance_critic_agent_calculate_performance_metrics(self, performance_critic_agent):
        ...
        metrics = performance_critic_agent._calculate_performance_metrics(predictions, test_data)
    ...
    def test_performance_critic_agent_calculate_risk_metrics(self, performance_critic_agent):
        ...
        metrics = performance_critic_agent._calculate_risk_metrics(predictions, test_data)
    ...
    def test_performance_critic_agent_calculate_trading_metrics(self, performance_critic_agent):
        ...
        metrics = performance_critic_agent._calculate_trading_metrics(predictions, test_data)
    ...
    def test_performance_critic_agent_generate_recommendations(self, performance_critic_agent):
...
class TestPerformanceCriticAgentIntegration:
    ...
    @pytest.mark.asyncio
    async def test_performance_critic_agent_multiple_evaluations(self, performance_critic_agent, mock_model, sample_test_data):
    ...
    @pytest.mark.asyncio
    async def test_performance_critic_agent_threshold_comparison(self, performance_critic_agent, mock_model, sample_test_data):
