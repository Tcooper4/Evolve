...
class TestSelfImprovingAgent:
    ...
    def test_learns_from_failed_predictions_and_adjusts_weights(self, mock_agent, sample_performance_data):
        ...
        self.assertIn('strategy_failure_rates', failure_analysis, "Should have strategy failure rates")
        self.assertIn('market_condition_failures', failure_analysis, "Should have market condition failures")
        self.assertIn('confidence_failure_correlation', failure_analysis, "Should have confidence correlation")
        self.assertIn('recommended_adjustments', failure_analysis, "Should have recommended adjustments")

        print(f"  Strategy failure rates: {failure_analysis['strategy_failure_rates']}")
        print(f"  Market condition failures: {failure_analysis['market_condition_failures']}")
        print(f"  Confidence correlation: {failure_analysis['confidence_failure_correlation']:.3f}")
        ...
        print(f"  Initial weights - RSI: {initial_rsi_weight:.3f}, MACD: {initial_macd_weight:.3f}, Bollinger: {initial_bollinger_weight:.3f}")
        ...
        self.assertIn('adjustment_reasons', adjustment_result, "Should have adjustment reasons")
        self.assertIn('expected_improvement', adjustment_result, "Should have expected improvement")
        ...
        print(f"  New weights - RSI: {new_rsi_weight:.3f}, MACD: {new_macd_weight:.3f}, Bollinger: {new_bollinger_weight:.3f}")
        ...
        self.assertIn('old_learning_rate', adaptation_result, "Should have old learning rate")
        self.assertIn('new_learning_rate', adaptation_result, "Should have new learning rate")
        self.assertIn('adaptation_factor', adaptation_result, "Should have adaptation factor")
        ...
        self.assertIsNotNone(updated_performance, "Updated performance should not be None")
        self.assertIn('bollinger_strategy', updated_performance, "Should have Bollinger performance")
        self.assertIn('rsi_strategy', updated_performance, "Should have RSI performance")
        self.assertIn('macd_strategy', updated_performance, "Should have MACD performance")
        ...
        self.assertIn('recommended_actions', threshold_alerts, "Should have recommended actions")
        ...
        self.assertIsNotNone(learning_cycle_result, "Learning cycle result should not be None")
        self.assertIn('cycle_id', learning_cycle_result, "Should have cycle ID")
        self.assertIn('improvements_made', learning_cycle_result, "Should have improvements")
        self.assertIn('performance_change', learning_cycle_result, "Should have performance change")
        self.assertIn('next_cycle_recommendations', learning_cycle_result, "Should have recommendations")
