...
class TestLLMRouter:
    ...
    def test_confidence_threshold(self, mock_router):
        ...
        high_conf_result = {"intent": "buy", "confidence": 0.9, "entities": ["AAPL"]}

        # Test low confidence
        low_conf_result = {"intent": "buy", "confidence": 0.3, "entities": ["AAPL"]}
    ...
    def test_performance_metrics(self, mock_router):
        ...
        test_inputs = ["Buy AAPL", "Sell TSLA", "Analyze GOOGL", "Show performance"]
