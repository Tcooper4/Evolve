...
class TestEnsembleVoting:
    ...
    def test_weight_distribution(self, ensemble_config):
        ...
        # Set initial weights
        initial_weights = {"lstm": 0.3, "transformer": 0.3, "xgboost": 0.4}
        ...
        unnormalized_weights = {"lstm": 3, "transformer": 3, "xgboost": 4}
    ...
    def test_fallback_mechanism(self, ensemble_config, sample_data):
        ...
        # Set weights
        weights = {"working": 0.4, "failing": 0.3, "broken": 0.3}
        # ensemble.set_weights(weights)
        ...
        with patch.object(
            MockForecastModel, "predict", side_effect=Exception("Model error")
        ):  # Mock the predict method directly
            predictions = []  # ensemble.predict(sample_data) # Not implemented yet
