...
def render_settings_page():
    ...
    with col2:
        ...
        alpha_vantage_key = st.text_input(
            "Alpha Vantage API Key", type="password", value=st.session_state.get("alpha_vantage_api_key", "")
        )
    ...
    with col1:
        ...
        default_model = st.selectbox(
            "Default Forecasting Model", ["LSTM", "Transformer", "XGBoost", "Ensemble"], index=0
        )
    ...
    with col1:
        ...
        data_source = st.selectbox("Primary Data Source", ["Alpha Vantage", "Yahoo Finance", "Polygon"], index=0)
    ...
    with col2:
        ...
        update_frequency = st.selectbox(
            "Data Update Frequency", ["1 minute", "5 minutes", "15 minutes", "1 hour", "1 day"], index=1
        )
