...
def run_backtest_strategy(strategy_name: str, symbol: str, start_date: datetime, 
    ...
    try:
        ...
        if strategy_name == "Bollinger Bands":
            ...
            from trading.strategies.rsi_strategy import RSIStrategy, RSIConfig
        ...
        max_drawdown = (sample_data['strategy_cumulative_returns'] / sample_data['strategy_cumulative_returns'].cummax() - 1).min()
        ...
        return {
            ...
            "metrics": {
                ...
                "win_rate": len(sample_data[sample_data['strategy_returns'] > 0]) / len(sample_data[sample_data['strategy_returns'] != 0])
            }
        }
