...
class ModelSelector:
    ...
    def render_model_selector(self) -> str:
        ...
        try:
            ...
            st.info(
                f"**{selected_model.upper()}**: {model_descriptions.get(selected_model, 'No description available')}"
            )
    ...
    def render_model_parameters(self, model: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if model == "transformer":
                ...
                params["changepoint_prior_scale"] = st.slider(
                    "Changepoint Prior Scale", 0.001, 0.5, 0.05
                )
                params["seasonality_prior_scale"] = st.slider(
                    "Seasonality Prior Scale", 0.01, 10.0, 1.0
                )
                ...
                params["weights"] = st.selectbox(
                    "Weighting method:", ["equal", "performance", "custom"]
                )
    ...
    def render_symbol_input(self) -> str:
        ...
        try:
            ...
            symbol = st.text_input(
                "Stock Symbol:", value="AAPL", help="Enter the stock symbol to forecast"
            ).upper()
