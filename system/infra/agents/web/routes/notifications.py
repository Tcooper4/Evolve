...
from automation.notifications.notification_manager import NotificationManager, NotificationPriority
...
async def get_notifications(
    ...
    try:
        ...
        if sort_by == "created_at":
            ...
            notifications.sort(key=lambda x: priority_order.get(NotificationPriority(x.get('priority', 'LOW')), 0), reverse=reverse)
        elif sort_by == "read":
