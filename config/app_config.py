...
class AppConfig:
    ...
    def _load_from_env(self):
        ...
        try:
            ...
            logger.warning(
                f"Invalid REDIS_PORT value '{redis_port_env}', using default {self.database.redis_port}: {e}"
            )
        ...
        try:
            ...
            logger.warning(
                f"Invalid POSITION_SIZE value '{position_size_env}', using default {self.strategies.position_size}: {e}"
            )
        ...
        try:
            ...
            logger.warning(
                f"Invalid MAX_DRAWDOWN value '{max_drawdown_env}', using default {self.risk.max_drawdown}: {e}"
            )
        ...
        try:
            ...
            logger.warning(
                f"Invalid MAX_LEVERAGE value '{max_leverage_env}', using default {self.risk.max_leverage}: {e}"
            )
        ...
        try:
            ...
            logger.warning(
                f"Invalid API_RATE_LIMIT value '{api_rate_limit_env}', using default {self.api.rate_limit}: {e}"
            )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "models": {
                ...
                "technical": {"indicators": self.models.technical_indicators},
            },
            "strategies": {
                "default": {
