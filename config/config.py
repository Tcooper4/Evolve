...
def load_env_config() -> Dict[str, str]:
    ...
    env_vars = [
        'HOST', 'PORT', 'DEBUG_MODE', 'LOG_LEVEL', 'LOG_FILE',
        'REDIS_HOST', 'REDIS_PORT', 'REDIS_PASSWORD',
        'DEFAULT_TIMEFRAME', 'FORECAST_HORIZON', 'CONFIDENCE_INTERVAL',
        'POSITION_SIZE', 'STOP_LOSS', 'TAKE_PROFIT', 'MAX_POSITIONS',
        'MAX_DRAWDOWN', 'MAX_LEVERAGE', 'NLP_CONFIDENCE_THRESHOLD',
        'API_RATE_LIMIT', 'API_TIMEOUT', 'MONITORING_ENABLED',
        'SSL_ENABLED', 'AUTH_ENABLED', 'DEV_DEBUG', 'TEST_MODE'
    ]
